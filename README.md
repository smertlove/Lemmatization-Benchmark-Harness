...
| `BART_6-6-9782_107m` | 106,953,216 | BART model with 4 layers of encoder/decoder and a mowphologically-aware tokenizer |
...
| Morph-aware tokenizer | 9,782 | `свежевскопанный` | 10 | `['<s>', 'свеж', '##ев', '##ск', '##оп', '##ан', '##н', '##ы', '##й', '</s>']` |
